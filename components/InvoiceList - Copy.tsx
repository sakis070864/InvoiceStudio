...
import { Search, FileText, Trash2, Edit3, Upload, Download, FileSpreadsheet, FileJson, Loader2, Info, X, Calendar, Filter, ArrowUp, ArrowDown, BarChart3 } from 'lucide-react';
    ...
    <div className="space-y-4">
      ...
      <div className="bg-sidebar p-4 rounded-xl border border-border space-y-4">
        ...
        <div className="flex flex-col xl:flex-row gap-4 justify-between items-start xl:items-center">
            ...
            {/* Actions and Sorting */}
            <div className="flex flex-col sm:flex-row items-center justify-between w-full xl:w-auto gap-3">
